...
This section will guide you through upgrading your Validora application to the latest version.
...
1. **Check for Updates**
   ...
   Validora automatically checks for updates once per day. However, you can manually check for updates at any time by visiting:
   ...
   ![No Updates Available](/validora/no-update.png)
...
2. **Review Update Information**
   ...
   ![Update Available](/validora/upgrade.png)
