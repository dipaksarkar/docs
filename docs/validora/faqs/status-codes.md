...
Validora assigns a status to every email address we verify. Each status helps you understand whether you should send emails to that address. Below are the main statuses and their sub-statuses.
...
[Learn more about Catch-All Emails](/validora/faqs/what-are-catch-all-domains)
...
[Read our Email Deliverability Guide.](/validora/faqs/email-deliverability)
