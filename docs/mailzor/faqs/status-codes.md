...
Mailzor assigns a status to every email address we verify. Each status helps you understand whether you should send emails to that address. Below are the main statuses and their sub-statuses.
...
[Learn more about Catch-All Emails](/mailzor/faqs/what-are-catch-all-domains)
...
- **free_email** — [true/false] Is the email from a free provider?
- **mx_record** — The preferred MX record of the domain.
- **smtp_provider** — The SMTP provider or [null].
...
[Read our Email Deliverability Guide.](/mailzor/faqs/email-deliverability)
